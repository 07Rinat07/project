...
<div class="admin-page__content-form">
	...
	<form class="admin-form" enctype="multipart/form-data" method="POST" action="<?=HOST?>admin/post-new">
		...
		<div class="admin-form__item">
			<label class="input__label">
				Заголовок поста
				<input name="title" class="input input--width-label" type="text" placeholder="Заголовок заголовок" />
			</label>
		</div>
		<div class="admin-form__item">
